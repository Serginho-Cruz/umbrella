...
String adaptRecordsOptionName(PaymentRecordSortOption option) {
  return switch (option) {
    PaymentRecordSortOption.byName => 'Nome',
    PaymentRecordSortOption.byValue => 'Valor',
    PaymentRecordSortOption.byPaymentDate => 'Data de Pagamento',
  };
}
