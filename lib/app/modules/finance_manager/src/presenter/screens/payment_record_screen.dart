...
class _PaymentRecordScreenState extends State<PaymentRecordScreen> {
  ...
  @override
  Widget build(BuildContext screenContext) => Observer(
                      ...
                      Padding(
                        ...
                        child: Observer(
                          builder: (_) => AccountSelector(
                            ...
                            accounts: accounts,
                            selectedAccount:
                                widget._accountStore.selectedAccount,
                            onSelected: (acc) {
                        ...
                        builder: (ctx) => SegmentedStateWidget(
                          ...
                          onState: (_, map) {
                            ...
                            return Observer(
                              builder: (_) {
                                var filtered =
                                    widget._recordStore.filteredState;

                                List<int> orderedKeys =
                                    _getOrderedKeys(filtered.keys.toList());
